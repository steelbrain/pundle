...
export function filterComponents(components: Set<ComponentConfigured>, type: string): Array<ComponentConfigured> {
  const filtered = []
...
export function invokeComponent(context: Context, entry: ComponentConfigured, method: string, configs: Array<Object>, ...givenParameters: Array<any>) {
